...
public class CommandDefineFunction extends Command {//dont extend commandblock because we only get the contents later because of header first parsing
    ...
    public FunctionHeader getHeader() {
        ...
        return new FunctionHeader((context.packageName != null ? context.packageName.replace(".", "Dot").replace("/", "slash") : context.packageName) + "__" + name, header.returnType, header.arguments);
    }
