...
class LineParser {
    ...
    public static Command keywordSection(List<Token> tokens, Context context) {
    ...
    public static Command eqSecond(List<Token> tokens, Context context, int eqLoc) {
        List<Token> after = tokens.subList(eqLoc + 1, tokens.size());
        boolean inferType = (Boolean) tokens.get(eqLoc).data();
    ...
    public static Command parseSettable(List<Token> tokens, Context context, int eqLoc) {
